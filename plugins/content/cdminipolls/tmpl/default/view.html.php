	  	...
	  	<?php foreach($options as $poll_option): ?>
		  	<div class="<?php echo $this->_name; ?>_option">
		  		...
		  		<div class="<?php echo $this->_name; ?>_votecontainer">
	  				...
	  				>
	  					<div class="<?php echo $this->_name; ?>_votebutton_layer">
				  			<div class="ui-widget-overlay ui-corner-all"></div>
				  			<div class="<?php echo $this->_name; ?>_votebutton_container ui-state-default ui-corner-all">
				  				<form action="" method="post">
					  				<?php echo JText::_('PLG_CONTENT_CDMINIPOLLS_VOTE_FOR_OPTION', true); ?>
