...
abstract class KunenaForum {
	...
	protected static function buildVersion() {
		if ('2.0.3' == '@' . 'kunenaversion' . '@') {
			...
			self::$version = strtoupper ( '2.0.3' );
		}
		self::$version_major = substr(self::$version, 0, 3);
		self::$version_date = ('2012-11-24' == '@' . 'kunenaversiondate' . '@') ? JFactory::getDate()->toMySQL() : '2012-11-24';
		self::$version_name = ('Reconciliation' == '@' . 'kunenaversionname' . '@') ? 'Git Repository' : 'Reconciliation';
	}
}
